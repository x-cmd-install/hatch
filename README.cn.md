...
合计: **60,727** 行代码（覆盖前 5 种语言、共 **412** 个文件）。
...
- **Star**: 7,235 · **Fork**: 457 · **开放 issue**: 1,074 · **贡献者**: 177

## 累计统计

- **发布数**: 150 · **已合并 PR**: 779 · **开放 PR**: 96 · **已关闭 issue**: 730 · **开放 issue**: 344 · **提交数**: 1113
...
在 [repology.org](https://repology.org/project/hatch) 上共有 **57** 个发行版报告此项目。**12** 个 ✅ 已是最新上游版本，**38** 个 ⚠️ 使用旧版本。
