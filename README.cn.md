...
[![x-cmd/install — hatch Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/hatch.svg?lang=zh)](https://x-cmd.com/install/hatch)
...
合计: **60,811** 行代码（覆盖前 5 种语言、共 **412** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Python | 59,265 | 703 | 14,765 | 401 |
| Toml | 1,027 | 10 | 49 | 7 |
| Yaml | 323 | 13 | 8 | 2 |
| Svg | 76 | 0 | 0 | 1 |
| Bitbake | 41 | 1 | 9 | 1 |
...
- **上游仓库**: <https://github.com/pypa/hatch>
- **官网**: <https://hatch.pypa.io/latest/>
- **许可证**: MIT

## 发布

- **最新版本**: `hatchling-v1.32.4` (2026-09-20)
- **最近提交**: 2026-09-20
- **Release 含资产**: 17 个

## 流行度

- **Star**: 7,236 · **Fork**: 466 · **开放 issue**: 1,083 · **贡献者**: 179

## 累计统计

- **发布数**: 153 · **已合并 PR**: 791 · **开放 PR**: 96 · **已关闭 issue**: 741 · **开放 issue**: 342 · **提交数**: 1125

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 3 | 11 | 9 | 6 | 4 | 16 |
| last60d | 2026-07-27 | 5 | 25 | 28 | 10 | 8 | 30 |
| 90d | 2026-06-27 | 7 | 34 | 38 | 13 | 10 | 38 |
| last180d | 2026-03-29 | 9 | 65 | 55 | 30 | 18 | 74 |
| 360d | 2025-09-30 | 19 | 112 | 65 | 81 | 45 | 121 |
| last720d | 2024-10-05 | 28 | 147 | 83 | 155 | 170 | 163 |
...
hatch 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `hatch` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/hatch.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:30:01Z._
